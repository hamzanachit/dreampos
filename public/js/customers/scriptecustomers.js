$(document).ready(function () {
    ...
    $('#addCustomerform').on('submit', function (event) {
        ...
        function sendFormData(formData) {
            $.ajax({
                url: basePath + '/customers/add', // Ensure this URL matches your route
                type: 'POST',
    ...
    $('#editCustomerForm').on('submit', function (event) {
        ...
        $.ajax({
            url: basePath + '/customers/edit', // Ensure this URL matches your route
            type: 'POST',
            data: JSON.stringify(formData),
            contentType: 'application/json',
            success: function (response, textStatus, xhr) {
    ...
    $('#deleteCustomerForm').on('submit', function (event) {
        ...
        $.ajax({
            url: basePath + '/customers/delete', // Ensure this URL matches your route
            type: 'POST',
            data: JSON.stringify(formData),
            contentType: 'application/json',
            success: function (response, textStatus, xhr) {
