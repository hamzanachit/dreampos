...
$(document).ready(function () {
  ...
  $('.editbtn').on('click', function (e) {
    ...
    var description = $(this).attr('data-item-description'); // console.log(categoryname);
  ...
  $('.deletebtn').on('click', function (e) {
    e.preventDefault();
    $('#deletecategoryModal').modal('show'); //  var idcategory = deleteBtn.attr('data-item-id');

    var idsubcategorydelete = $(this).attr('data-item-id'); // console.log(idsubcategorydelete);
