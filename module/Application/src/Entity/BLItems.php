 ...
 * BLItems
 *
 * @ORM\Table(name="bl_items", indexes={@ORM\Index(name="created_by", columns={"created_by"}), @ORM\Index(name="idcompany", columns={"idcompany"}), @ORM\Index(name="order_id", columns={"order_id"}), @ORM\Index(name="updated_by", columns={"updated_by"})})
 * @ORM\Entity
 */
class BLItems
{
